import { TASK_PRIORITY_LABELS, TASK_PRIORITY_COLORS } from '../data/taskStructure'
...
export const TaskCard = ({ task }) => {
  return (
    <div className="group cursor-pointer rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:shadow-lg">
      <div className="mb-3">
