...
- [x] 반응형 디자인 (Desktop 1920px, Tablet 768px, Mobile 375px)
- [ ] 애니메이션 효과
- [ ] 다크 모드
- [ ] 빈 상태 안내 메세지
...
- 카드 추가/삭제 시 애니메이션
- 모달 열기/닫기 애니메이션
- 모바일 모달 드래그 애니메이션 효과도 추가
  - 100px 내리면 opacity 100 -> 0 으로 변하면서 화면 하단 끝까지 내려감.
  - background 값도 조정 가능하다면 조정할 수 있도록 함
